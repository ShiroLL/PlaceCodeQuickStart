...
import top.hllcloud.QRcode.PlaceCode.QuickStart.databinding.HomeBinding;
...
public class HomeFragment extends BaseFragment<HomeBinding> {
    ...
    @NonNull
    @Override
    protected HomeBinding viewBindingInflate(LayoutInflater inflater, ViewGroup container) {
